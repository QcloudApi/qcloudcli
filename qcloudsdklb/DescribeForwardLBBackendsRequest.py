...
class DescribeForwardLBBackendsRequest(Request):

    def __init__(self):
        super(DescribeForwardLBBackendsRequest, self).__init__(
            'lb', 'qcloudcliV1', 'DescribeForwardLBBackends', 'lb.api.qcloud.com')
