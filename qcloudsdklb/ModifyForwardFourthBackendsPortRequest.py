...
class ModifyForwardFourthBackendsPortRequest(Request):

    def __init__(self):
        super(ModifyForwardFourthBackendsPortRequest, self).__init__(
            'lb', 'qcloudcliV1', 'ModifyForwardFourthBackendsPort', 'lb.api.qcloud.com')
