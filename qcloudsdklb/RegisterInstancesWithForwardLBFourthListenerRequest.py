...
class RegisterInstancesWithForwardLBFourthListenerRequest(Request):

    def __init__(self):
        super(RegisterInstancesWithForwardLBFourthListenerRequest, self).__init__(
            'lb', 'qcloudcliV1', 'RegisterInstancesWithForwardLBFourthListener', 'lb.api.qcloud.com')
