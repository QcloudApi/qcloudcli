...
class ModifyForwardSeventhBackendsRequest(Request):

    def __init__(self):
        super(ModifyForwardSeventhBackendsRequest, self).__init__(
            'lb', 'qcloudcliV1', 'ModifyForwardSeventhBackends', 'lb.api.qcloud.com')
