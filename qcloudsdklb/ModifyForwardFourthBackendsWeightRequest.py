...
class ModifyForwardFourthBackendsWeightRequest(Request):

    def __init__(self):
        super(ModifyForwardFourthBackendsWeightRequest, self).__init__(
            'lb', 'qcloudcliV1', 'ModifyForwardFourthBackendsWeight', 'lb.api.qcloud.com')
