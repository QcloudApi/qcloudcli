...
class RegisterInstancesWithForwardLBSeventhListenerRequest(Request):

    def __init__(self):
        super(RegisterInstancesWithForwardLBSeventhListenerRequest, self).__init__(
            'lb', 'qcloudcliV1', 'RegisterInstancesWithForwardLBSeventhListener', 'lb.api.qcloud.com')
