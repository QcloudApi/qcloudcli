...
class DeregisterInstancesFromForwardLBRequest(Request):

    def __init__(self):
        super(DeregisterInstancesFromForwardLBRequest, self).__init__(
            'lb', 'qcloudcliV1', 'DeregisterInstancesFromForwardLB', 'lb.api.qcloud.com')
