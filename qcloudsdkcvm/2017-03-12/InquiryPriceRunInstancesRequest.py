...
class InquiryPriceRunInstancesRequest(Request):

    def __init__(self):
        super(InquiryPriceRunInstancesRequest, self).__init__(
            'cvm', 'qcloudcliV1', 'InquiryPriceRunInstances', 'cvm.api.qcloud.com')
