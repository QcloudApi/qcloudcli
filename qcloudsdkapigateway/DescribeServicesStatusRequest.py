...
class DescribeServicesStatusRequest(Request):

    def __init__(self):
        super(DescribeServicesStatusRequest, self).__init__(
            'apigateway', 'qcloudcliV1', 'DescribeServicesStatus', 'apigateway.api.qcloud.com')
    ...
    def get_serviceIds(self):
        return self.get_params().get('serviceIds')

    def set_serviceIds(self, serviceIds):
        self.add_param('serviceIds', serviceIds)
