...
class DescribeComputeEnvCreateInfosRequest(Request):

    def __init__(self):
        super(DescribeComputeEnvCreateInfosRequest, self).__init__(
            'batch', 'qcloudcliV1', 'DescribeComputeEnvCreateInfos', 'batch.api.qcloud.com')
